 ...
 */
public class Search_Fragment_vp1 extends Fragment implements View.OnClickListener{

    private XCRoundRectImageView view1,view2;

    public Search_Fragment_vp1() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_search__fragment_vp, container, false);
