...
public class Activity_Serach_base extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_activity__serach_base);
        ...
        String serach_title = intent.getStringExtra("serach_title");
        System.out.println("serach_title="+serach_title);
        tv.setText(serach_title);



        try {
            String str = new String(serach_title.getBytes(), "UTF-8");
            str = URLEncoder.encode(str, "UTF-8");
            System.out.println("str="+str);
            Path="http://bz.budejie.com/?typeid=2&ver=3.4.3&no_cry=1&client=android&c=search&a=search&q="+str+"&p=1&s=30";
        ...
        System.out.println("url_search="+serach_title);

        System.out.println("path="+Path);


        wm = Activity_Serach_base.this.getWindowManager();
                ...
                try {
                    ...
                    runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            System.out.println("rearch_item="+rearch_item);
