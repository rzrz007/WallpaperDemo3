...
import com.example.zren.wallpaperdemo3.domain.Serach_10sort;
...
public class Activity_Search_10sort_detial extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_activity__search_10point_detial);

        Intent intent = getIntent();
        String url_search = intent.getStringExtra("point_detial");

        System.out.println("point_detial="+url_search);
        Path="http://bz.budejie.com/?typeid=2&ver=3.4.3&no_cry=1&client=android&c=topic&a=detail&index=1&size=9&typeid=2&topicid="+url_search;



        wm = Activity_Search_10sort_detial.this.getWindowManager();
                ...
                try {
                    ...
                    runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            Serach_10sort serach_10sort = gson.fromJson(JsonString, Serach_10sort.class);
                            Images.ImageList=new ArrayList<String>();
                            System.out.println(serach_10sort.getData().getPic_List().size());
                            for(int i=0;i<serach_10sort.getData().getPic_List().size();i++){
                                Images.ImageList.add(serach_10sort.getData().getPic_List().get(i).getWallPaperMiddle());
                            }
