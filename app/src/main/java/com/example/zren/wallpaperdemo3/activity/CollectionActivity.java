...
public class CollectionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        readSdcard = new Thread() {
            ...
            private String sdpath = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DCIM).getAbsolutePath();
        ...
        final BaseAdapter baseAdapter = new BaseAdapter() {
            ...
            public View getView(int position, View convertView, ViewGroup viewGroup) {
                ...
                if (convertView == null) {
                    imageView_son = new ImageView(CollectionActivity.this);
                    // 自动缩放为宽高比
        ...
        gridView_showPic.setOnItemClickListener(new AdapterView.OnItemClickListener() {// 点击网格组件的任意一张图片时候的事件
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(CollectionActivity.this, Download_sonPic_Activity.class);
        ...
        gridView_showPic.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (file.exists()) {
                    new AlertDialog.Builder(CollectionActivity.this).setTitle("提示：").setMessage("是否删除？").setNegativeButton("是的", new DialogInterface.OnClickListener() {
                        @Override
                    ...
                    Toast.makeText(CollectionActivity.this, "图片不存在", Toast.LENGTH_SHORT).show();
                }
